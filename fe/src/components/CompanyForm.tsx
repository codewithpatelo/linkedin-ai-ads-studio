      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Generate 5 unique, high-converting LinkedIn advertisement images
            tailored to your company and audience.
          </p>
        </div>
        ...
        <Card className="bg-gradient-card shadow-elevated border-0 hover-lift animate-slide-up">
          <CardHeader className="text-center">
            ...
            <p className="text-muted-foreground">
              Tell us about your company to create targeted ads
            </p>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleChange("businessValue", e.target.value)
                  }
                  className="bg-background/50 input-focus"
                  required
                />
          ...
          <Card className="bg-white/95 backdrop-blur-md shadow-2xl border-0 p-8 max-w-md mx-4">
            <div className="text-center space-y-6">
              <div className="relative">
                ...
                <div
                  className="absolute inset-0 w-16 h-16 mx-auto border-4 border-transparent border-r-blue-400 rounded-full animate-spin animate-reverse"
              ...
              <div className="space-y-3">
                <h3 className="text-xl font-semibold text-gray-900">
                  Generating LinkedIn Ads
                </h3>
                <p className="text-gray-600 text-sm leading-relaxed">
                  {progressMessage ||
                    "Please wait while we create your personalized ads..."}
                </p>
